(function() {
	...
	function init(Guid) {
		...
		function onReady() {
			...
			function logPageViewUnload(pageView) {
				...
				try {
					...
					logPageViewOldStyle(pageView);
				}
			}
			
			function logPageViewOldStyle(pageView) {
				try {
			...
			function logUnload(pageViewGuid, clickedType, clickedCompany, clickedText, clickedUrl) {
				if (!submittedData) {
					...
					logPageViewUnload(pageViewObject);
					submittedData = true;
				}
			}
			...
			function logLoad(pageViewGuid) {
				...
				logPageViewOldStyle(pageViewObject);
			}
