(function () {
	...
	function init(_, eventLogging, VisibilityTesterModule) {
		...
		function onReady() {
			 ...
			 * @type {string[]}
			 */
			var customEvents = ['stripeError', 'regError', 'videoEvent', 'fullscreenEvent', 'barShown', 'videoToolbarEvent', 'videoLoad', 'qualarooShown', 'qualarooClosed', 'regFormModalError', 'videoPlayEvent', 'debugInfo'];
